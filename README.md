...
![Portrait within geofence](portrait.png)
![Portrait with alert logs and unavailable gps location](portrait2.png)
![Landscape camera image](landscape.png)
![Preference settings](settings.png)
